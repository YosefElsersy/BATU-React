...
export default function SupremeCouncil() {

  const {t} = useTranslation();
  useEffect(() => {
    // Set the document title when the component mounts
    document.title = t("Supreme Council - BATU");
